...
class HistoricalPvoRegistro(SimpleHistoryAdmin):
    list_display = ['pid', 'fecha_full', 'fecha_flp', 'fecha_fef', 'creado_por', 'fecha_creacion', 'get_changed_fields']
    ...
    def get_changed_fields(self, obj):
        try:
            ...
            for field in obj._meta.fields:
                ...
                if field_name in ['history_id', 'history_date', 'history_user', 'history_type', 'history_change_reason', 'id']:
